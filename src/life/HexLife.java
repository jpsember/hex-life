...
public class HexLife implements ILife {
  ...
  private int nNeighbors(IPoint2 c) {
    ...
    if (hasCell(work))
      nc++;
    //    Streams.out.println("nNeighbors " + c + " = " + nc);
    return nc;
  }
  ...
  public void update() {
    ...
    for (Iterator it = cells.keySet().iterator(); it.hasNext();) {
      ...
      IPoint2 n0 = new IPoint2(cell.x - 1, cell.y);
      IPoint2 n1 = new IPoint2(cell.x - 1, cell.y + 1);
      IPoint2 n2 = new IPoint2(cell.x, cell.y + 1);
      IPoint2 n3 = new IPoint2(cell.x + 1, cell.y);
      IPoint2 n4 = new IPoint2(cell.x + 1, cell.y - 1);
      IPoint2 n5 = new IPoint2(cell.x, cell.y - 1);
